...
import { PeerSquad, peerSquadService } from '@/services/peerSquadService';
...
const PeerSquadPage = () => {
  ...
  // Fetch user profile and peer squads on mount
  useEffect(() => {
  ...
  const loadPeerSquads = async () => {
    ...
    try {
      const [allSquadsData, mySquadsData] = await Promise.all([
        peerSquadService.getAllPeerSquads(),
  ...
  const handleCreateSquad = async () => {
    ...
    try {
      const squadId = await peerSquadService.createPeerSquad(newSquad);
